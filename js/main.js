...
<nav class="navbar navbar-expand-lg navbar-light">
    <div class="container">
        <button id="navbarButton" class="navbar-toggler bg-light" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
...
<nav class="navbar navbar-expand-lg navbar-light">
<div class="container">
    <button id="navbarButton" class="navbar-toggler bg-light" type="button" data-bs-toggle="collapse"
...
let pag_actual = window.location.pathname;//obtengo la ruta del archivo para verificar si esta dentro del directorio paginas o no
